...
read_tables("output_macro_pass1.txt")
process_source_file("input_macro_pass2.txt", "output_macro_pass2.txt")
save_aptab_to_file("output_macro_pass2_aptab_output.txt")
print("Macro expansion completed. Check 'expanded_source.txt' for the result.")
